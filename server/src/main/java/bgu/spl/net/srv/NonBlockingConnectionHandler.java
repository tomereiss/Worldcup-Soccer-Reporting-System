...
public class NonBlockingConnectionHandler<T> implements ConnectionHandler<T> {
    ...
    public NonBlockingConnectionHandler(MessageEncoderDecoder<String> reader, StompMessagingProtocol protocol,
                                        SocketChannel chan, Reactor reactor, int connectionId_, Connections connections) {
        this.chan = chan;
        this.encdec = reader;
